...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    async function loadTransactions(): Promise<void> {
      ...
      const formatDataTransactions: Transaction[] = data.transactions.map(
        transaction => ({
          ...transaction,
      ...
      const formatDataBalance: Balance = {
      ...
      setTransactions(formatDataTransactions);
      setBalance(formatDataBalance);
    }
